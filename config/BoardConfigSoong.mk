...
$(call soong_config_set,hertzify_bootanimation,height,$(TARGET_SCREEN_HEIGHT))
$(call soong_config_set,hertzify_bootanimation,width,$(TARGET_SCREEN_WIDTH))
$(call soong_config_set,hertzify_bootanimation,half_res,$(TARGET_BOOTANIMATION_HALF_RES))

ifneq ($(TARGET_BOOTANIMATION),)
$(call soong_config_set,hertzify_bootanimation,prebuilt_file,$(TARGET_BOOTANIMATION))
endif

# Charger
hertzify_charger_density := mdpi
ifneq (,$(TARGET_SCREEN_DENSITY))
hertzify_charger_density := $(strip \
...
hertzify_charger_density := $(PRODUCT_AAPT_PREF_CONFIG)
endif
