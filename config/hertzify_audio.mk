#
# Hertzify Audio Files
#

ALARM_PATH := vendor/hertzify/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/hertzify/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/hertzify/prebuilt/common/media/audio/ringtones
